 ...
 * Generated for Laravel 5.5.48 on 2019-09-19 01:12:20.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function success($code = 200, $msg = 'success', $data = '', $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::success($code, $msg, $data, $status);
        }
         ...
         * @static 
         */ 
        public static function fail($code = 100, $msg = 'fail', $data = '', $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::fail($code, $msg, $data, $status);
        }
